...
def convergence_calculation(data_arr, sum_of_diff_new, mean_new, num_of_clusters, init):
    count = 1
    run_time = [1]
    ...
    #         min_diff = float(sys.maxsize)
    #         c = 0
    #         for k in range(1, num_of_clusters + 1):  # upto num of clusters
    #             diff_ = dis(i, j, mean_new["u" + str(k)][0], mean_new["u" + str(k)][1])
    #             if (diff_ < min_diff):
    #                 min_diff = diff_
    #                 c = k
    ...
    str1 = "for initialization "+str(init)
...
for i in range(5):
    ...
    convergence_calculation(data_arr, sum_of_diff_new, mean_new, num_of_clusters, i+1)
